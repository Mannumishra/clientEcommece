...
const AllBanner = () => {
    ...
    const getBanner = async () => {
        try {
            const res = await axios.get("https://induserver.assortsmachinetools.com/api/banner");
    ...
    const deleteBanner = async (_id) => {
        setLoading(true);
        try {
            const res = await axios.delete("https://induserver.assortsmachinetools.com/api/banner/" + _id);
            if (res.status === 200) {
