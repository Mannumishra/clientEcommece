...
const EditBanner = () => {
    ...
    const getApiData = async () => {
        try {
            const res = await axios.get("https://induserver.assortsmachinetools.com/api/banner/" + _id)
    ...
    const postData = async (e) => {
        ...
        setBtnLoading(true)
        try {
            const res = await axios.put("https://induserver.assortsmachinetools.com/api/banner/" + _id, formData)
            if(res.status===200){
