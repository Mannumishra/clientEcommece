...
const EditCategory = () => {
    ...
    const getApiData = async () => {
        try {
            const res = await axios.get("https://induserver.assortsmachinetools.com/api/category/" + _id)
            if (res.status === 200) {
    ...
    const postData = async (e) => {
        ...
        setBtnLoading(true)
        try {
            const res = await axios.put("https://induserver.assortsmachinetools.com/api/category/" + _id, formdata)
            if (res.status === 200) {
                setBtnLoading(false)
